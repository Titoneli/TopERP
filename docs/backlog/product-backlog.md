...
| ID | Épico | Módulo | Status |
|----|-------|--------|--------|
| EP-001 | Gestão Financeira Básica | FIN | Planejado |
| EP-002 | Controle de Vendas | VEN | Planejado |
| EP-003 | Gestão de Compras | COM | Planejado |
...
|----|----------|------------|--------|--------|
| US-FIN-001 | Cadastro de contas a pagar | Essencial | Backlog | - |
| US-FIN-002 | Cadastro de contas a receber | Essencial | Backlog | - |
| US-FIN-003 | Baixa de títulos | Essencial | Backlog | - |
| US-FIN-004 | Fluxo de caixa básico | Essencial | Backlog | - |

#### Importante
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-FIN-010 | Conciliação bancária | Importante | Backlog | - |
| US-FIN-011 | Relatório de inadimplência | Importante | Backlog | - |
...
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-VEN-001 | Cadastro de clientes | Essencial | Backlog | - |
| US-VEN-002 | Cadastro de pedidos de venda | Essencial | Backlog | - |
| US-VEN-003 | Faturamento de pedidos | Essencial | Backlog | - |
| US-VEN-004 | Emissão de NF-e | Essencial | Backlog | - |

#### Importante
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-VEN-010 | Orçamentos | Importante | Backlog | - |
| US-VEN-011 | Comissões de vendedores | Importante | Backlog | - |
...
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-COM-001 | Cadastro de fornecedores | Essencial | Backlog | - |
| US-COM-002 | Pedido de compra | Essencial | Backlog | - |
| US-COM-003 | Entrada de nota fiscal | Essencial | Backlog | - |

#### Importante
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-COM-010 | Cotação de preços | Importante | Backlog | - |
| US-COM-011 | Aprovação de compras | Importante | Backlog | - |
...
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-EST-001 | Cadastro de produtos | Essencial | Backlog | - |
| US-EST-002 | Movimentação de estoque | Essencial | Backlog | - |
| US-EST-003 | Consulta de saldos | Essencial | Backlog | - |

#### Importante
| ID | História | Prioridade | Status | Sprint |
|----|----------|------------|--------|--------|
| US-EST-010 | Inventário | Importante | Backlog | - |
| US-EST-011 | Curva ABC | Importante | Backlog | - |
...
1. [x] Definir Product Owner
2. [ ] Realizar Discovery com stakeholders
